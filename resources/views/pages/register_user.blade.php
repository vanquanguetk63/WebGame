...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Đăng Ký</span> </span></h3>
        ...
        ?>
        <form action="{{URL::to('/add-user')}}" class="nk-form" method="POST">
            {{ csrf_field() }}
            <div class="row vertical-gap">
                <div class="col-lg-6">

                     <div class="nk-gap-1"></div>
                    <label for="fname">Tên <span class="text-main-1">*</span>:</label>
                    <input type="text" class="form-control required" name="user_name" id="fname">
                    <div class="nk-gap-1"></div>

                    <div class="nk-gap-1"></div>
                    <label for="fname">Email <span class="text-main-1">*</span>:</label>
                    <input type="text" class="form-control required" name="user_email" id="fname">
                    <div class="nk-gap-1"></div>
                    ...
                    <input type="password" class="form-control required" name="user_password" id="fname">
                    <div class="nk-gap-1"></div>


                    <div class="nk-gap-1"></div>
                    <label for="fname">Số Điện Thoại<span class="text-main-1">*</span>:</label>
                    <input type="text" class="form-control required" name="user_phone" id="fname">
                    <div class="nk-gap-1"></div>

                    <button type="submit" class="nk-btn nk-btn-rounded nk-btn-color-main-1">Đăng Ký</button>
