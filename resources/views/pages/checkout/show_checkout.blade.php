...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Thanh Toán</span> </span></h3>

        <!-- START: Billing Details -->
        <div class="nk-gap"></div>
        <form action="{{URL::to('/save-checkout-user')}}" class="nk-form" method="POST">
            {{ csrf_field() }}
             <div class="nk-gap-1"></div>
                    <label for="fname">Tên Người Nhận   <span class="text-main-1">*</span>:</label>
                    <input type="text" class="form-control required" name="ship_name" id="fname">
                    <div class="nk-gap-1"></div>
                    ...
                    <div class="nk-gap-1"></div>
                    <label for="fname">Địa Chỉ <span class="text-main-1">*</span>:</label>
                    <input type="text" class="form-control required" name="ship_address" id="fname">
                    <div class="nk-gap-1"></div>


                     <label for="fname">Số Điện Thoại <span class="text-main-1">*</span>:</label>
                    <input type="text" class="form-control required" name="ship_phone" id="fname">
                    <div class="nk-gap-1"></div>
                    <button type="submit" class="nk-btn nk-btn-rounded nk-btn-color-main-1">Xem Lại Giỏ Hàng</button>
        </form>
