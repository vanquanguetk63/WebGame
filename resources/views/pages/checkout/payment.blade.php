...
<div class="container">
    <ul class="nk-breadcrumbs">
       ...
       <li><a href="{{URL::to('/')}}">Trang Chủ</a></li>
        ...
        <li><span>Xem Lại Đơn Hàng</span></li>
...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        ...
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Đơn Hàng Của Bạn</span></span></h3>
            ...
            <table class="nk-table nk-table-sm">
                <thead class="thead-default">
                    ...
                    <tr>
                        ...
                        <th class="nk-product-cart-title">Giá</th>
                        <th class="nk-product-cart-title">Số Lượng</th>
                        <th class="nk-product-cart-total">Đơn Giá</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <a class="nk-btn nk-btn-rounded nk-btn-color-main-1" href="{{URL::to('/order-place')}}">Thanh Toán</a>
