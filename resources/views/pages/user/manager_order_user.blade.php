...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        ...
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Lịch Sử Mua Hàng</span></span></h3>
        ...
        <div class="table-responsive">
            <table class="nk-table nk-table-sm">
                <thead class="thead-default">
                    ...
                    <tr>
                        <th class="nk-product-cart-title">Mã Đơn</th>
                        <th class="nk-product-cart-title">Thời Gian Đặt</th>
                        <th class="nk-product-cart-title">Tình Trạng</th>
                        <th class="nk-product-cart-title">Chi Tiết</th>
                        <th class="nk-product-cart-title">Hủy</th>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                               <a onclick="return confirm('Bạn Có Chắc Là Muốn Hủy Đơn Hàng Không ?')" href="{{URL::to('/delete-order-user/'.$order->order_id)}}" class="active styling-edit" ui-toggle-class="">
